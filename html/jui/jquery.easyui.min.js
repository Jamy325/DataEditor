...
if(opts.modal==true){
_27f.mask=$("<div class=\"window-mask\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></iframe></div>").insertAfter(_27f.window);
...
if(opts.shadow==true){
_27f.shadow=$("<div class=\"window-shadow\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></iframe></div>").insertAfter(_27f.window);
...
function find(_85f,_860){
	...
	var cc=[data];
	if (!window.__findCache__){
		window.__findCache__= {};
	}
	
	if (window.__findCache__ [_860]){
		return window.__findCache__[_860];
	}
	...
	while(cc.length){
		...
		for(var i=0;i < c.length;i++){
			...
			if(node[opts.idField] == _860){
				window.__findCache__ [_860] = node;
				return node;
			}else{
				if(node["children"]){
...
if(!_90d.panel){
_90d.panel=$("<div class=\"combo-panel\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></iframe></div>").appendTo("body");
